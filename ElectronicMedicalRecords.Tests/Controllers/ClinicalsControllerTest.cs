...
namespace ElectronicMedicalRecords.Tests.Controllers
{
    ...
    public class ClinicalsControllerTest
    {
        ...
        public void CreateOldPatientP()
        {
            ...
            {
                Circles = rand.ToString(),
                Respiration = rand.ToString(),
                Digestion = rand.ToString(),
                KidneyUrology = rand.ToString(),
                MuscleBoneJoint = rand.ToString(),
                Nerve = rand.ToString(),
                Mental = rand.ToString(),
                Surgery = rand.ToString(),
                ObstetricsAndGynecology = rand.ToString(),
